...
const Timeline: React.FC<TimelineProps> = ({ items }) => {
  return (
    <section className="relative w-full max-w-[1400px] mx-auto px-[clamp(1rem,4vw,2rem)] py-[clamp(3rem,8vw,6rem)]">
        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div className={`w-full md:w-[calc(50%-clamp(2rem,6vw,4rem))] pl-[clamp(3rem,6vw,4rem)] md:pl-0 ${isEven ? "md:mr-auto" : "md:ml-auto"}`}>
                <motion.div
