...
export default function PageLayout({ children }: ChildrenProps) {
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,var(--color-background-secondary)_0%,var(--color-background-primary)_35%,var(--color-background-primary)_65%,var(--color-background-secondary)_100%)]">
      <Sidebar />
